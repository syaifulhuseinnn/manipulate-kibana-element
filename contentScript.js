function checkClass() {
    ...
    let euiPanel = document.querySelector('div[data-test-subj="comboBoxOptionsList filterFieldSuggestionList-optionsList"]')
    ...
    if (euiPanel != null) {
        ...
        reactVirtualizedGrid.style.width = "408px"
